...
function embedProject() {
  sdk.embedProjectId('stackBlitz-embed', 'vitejs-vite-ebofjciu', {
    openFile: 'README.md',
  });
}
...
<body>
  ...
  <script>
    const markdownContent = \`## Marketing Campaign Requirements for Payments System for Electric Car Chargers:
